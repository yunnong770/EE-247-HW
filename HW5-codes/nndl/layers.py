...
#         cache = x, gamma, var, mu, eps
        cache = x, gamma, var, mu, eps, mode, momentum
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    bn_param['running_mean'] = momentum*bn_param['running_mean'] + (1-momentum)*running_mean
    bn_param['running_var'] = momentum*bn_param['running_var'] + (1-momentum)*running_var
...
def batchnorm_backward(dout, cache):
    ...
    dldx = dout*gamma
    dx = (1. / N)/ np.sqrt(var + eps) * (N*dldx - np.sum(dldx, axis=0)- x*np.sum(dldx*x, axis=0))
