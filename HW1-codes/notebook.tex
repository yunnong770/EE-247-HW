...
ECE C147/C247, Winter Quarter 2021, Prof.~J.C. Kao, TAs: N. Evirgen, A.
Ghosh, S. Mathur, T. Monsoor, G. Zhao
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} [<matplotlib.lines.Line2D at 0x1c9e5dee6c8>]
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{N} \PY{o}{=} \PY{l+m+mi}{5}
        ...
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N}\PY{p}{)}\PY{p}{:}
            \PY{n}{xhat\PYZus{}temp} \PY{o}{=} \PY{n}{xhat}
            \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i}\PY{p}{)}\PY{p}{:}
                \PY{n}{xhat\PYZus{}temp} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{vstack}\PY{p}{(}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{power}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{j}\PY{o}{+}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{n}{xhat\PYZus{}temp}\PY{p}{)}\PY{p}{)}
                
            \PY{n}{xhats}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{xhat\PYZus{}temp}\PY{p}{)}
            \PY{n}{theta\PYZus{}temp} \PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{xhat\PYZus{}temp}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{xhat\PYZus{}temp}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{xhat\PYZus{}temp}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{y}\PY{p}{)}\PY{p}{)}
            \PY{n}{thetas}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{theta\PYZus{}temp}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{training\PYZus{}errors} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        ...
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{training\PYZus{}error\PYZus{}temp} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2}\PY{o}{*}\PY{p}{(}\PY{n}{yhat} \PY{o}{\PYZhy{}} \PY{n}{y}\PY{p}{)}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{training\PYZus{}errors}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{training\PYZus{}error\PYZus{}temp}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{testing\PYZus{}errors} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         ...
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N}\PY{p}{)}\PY{p}{:}
             \PY{n}{yhat} \PY{o}{=} \PY{n}{thetas}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{xhats}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
             \PY{n}{testing\PYZus{}error\PYZus{}temp} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2}\PY{o}{*}\PY{p}{(}\PY{n}{yhat} \PY{o}{\PYZhy{}} \PY{n}{y}\PY{p}{)}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}
             \PY{n}{testing\PYZus{}errors}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{testing\PYZus{}error\PYZus{}temp}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Testing errors are: 
 [80.86165184550595, 213.1919244505843, 3.1256971083130622, 1.187076519481521, 214.91021816565478]
